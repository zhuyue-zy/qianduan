...
class MultiLanguageFormItem extends Component {
   ...
   */
  renderMultiFormItem = () => {
    const { onBlurInput,value, inputWidth, maxLength,enMaxLength, label, type, editable, handleDoubleClick, disabled, placeholder } = this.props;
  ...
  renderMultiLanguageModal = () => {
    const { required, languageEnv, descriptionObject,maxLength ,enMaxLength,onBlur} = this.props;
