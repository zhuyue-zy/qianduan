...
import phone_logo from '../../../../../assets/images/tab_phone.png';
import customerservice_logo from '../../../../../assets/images/tab_customerservice.png';
import dynamic_logo from '../../../../../assets/images/tab_dynamic.png';
import knowledge_logo from '../../../../../assets/images/tab_knowledge-search.png';
import space_logo from '../../../../../assets/images/tab_space.png';
import ServicePortalStore from "../../../../../stores/organization/servicePortal";

const intlPrefix = 'organization.servicePortal';

const BackgroundUrl = [];
BackgroundUrl.push(phone_logo);
BackgroundUrl.push(customerservice_logo);
BackgroundUrl.push(dynamic_logo);
...
export default class AvatarUploader extends Component {
                ...
                <li onClick={() => this.bgTuBiaoClickAll(v, i)}>
                  ...
                  >
                    <span
                      ...
                      style={{
                        background:colorOne,
                        border: tuBiaoVs[i] ? 'solid 1px #fff' : `solid 1px ${colorOne}`
                      }}
                    >
  ...
  // 上传图片
  uploadImg = () => {
    const button = document.getElementById('uploadButton_tabFive');
    button.click();
  };
      ...
      <div className="App">
        <div className="App-left">
          ...
          <span className="App-left-footer">
            ...
            <div className="crop-upload-button" style={{ display: 'none' }}>
              <input type="file" id="uploadButton_tabFive" onChange={this.onSelectFile} name='图片名字' accept=".jpg,.png,.jpeg" />
            </div>
        ...
        <div className="App-right">
          ...
          <div className="crop-content-preview-main">
            {croppedImageUrl ? <img style={{background:colorOne}} className="preview-imgcontent" alt="Crop" src={croppedImageUrl} /> : <img className="preview-imgcontent" alt="Crop" src={bigImg} />}
          </div>
        </div>
      </div>
    );
  ...
  render() {
    const { visible, AppState,colorOne } = this.props;
    ...
    return (
      <div>
        <Modal
          ...
          className="service_tab_five_template-info-avatar-modal-kb"
          visible={visible}
          // visible={true}
          width={600}
          // closable={false}
