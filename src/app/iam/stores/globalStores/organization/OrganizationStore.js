...
class OrganizationStore {
  ...
  checkProjectName = organizationId => axios.get(`/uaa/v1/organization/${organizationId}/projects/self`);

  checkProjectCode = (organizationId, codes) => axios.get(`/uaa/v1/organization/${organizationId}/projects/code?code=${codes}`);

  createOrg = (organizationId, projectData) => axios.post(`/uaa/v1/organization/${organizationId}/projects`, JSON.stringify(projectData));

  updateOrg = (organizationId, Data) => axios.put(`/iam/v1/organizations/${organizationId}`, JSON.stringify(Data));

  getOrgById = organizationId => axios.get(`/iam/v1/organizations/${organizationId}`);

  deleteOrgById = (organizationId, id) => axios.delete(`/uaa/v1/organization/${organizationId}/projects/${id}`);
