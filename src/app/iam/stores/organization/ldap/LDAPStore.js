...
@store('LDAPStore')
class LDAPStore extends LanguageStore {
  ...
  updateLDAP = (organizationId, id, ldap) => axios.post(`/iam/v1/organizations/${organizationId}/ldaps/${id}`, JSON.stringify(ldap));

  testConnect = (organizationId, id, ldap) => axios.post(`/iam/v1/organizations/${organizationId}/ldaps/${id}/test_connect`, JSON.stringify(ldap));

  getSyncInfo = (organizationId, id) => axios.get(`/iam/v1/organizations/${organizationId}/ldaps/${id}/latest_history`);

  SyncUsers = (organizationId, id) => axios.post(`/iam/v1/organizations/${organizationId}/ldaps/${id}/sync_users`);

  enabledLdap = (organizationId, id) => axios.put(`/iam/v1/organizations/${organizationId}/ldaps/${id}/enable`);

  disabledLdap = (organizationId, id) => axios.put(`/iam/v1/organizations/${organizationId}/ldaps/${id}/disable`);
}
